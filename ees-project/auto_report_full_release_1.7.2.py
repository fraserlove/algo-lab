"""
EES Project Automatic Reporting Software - Release Version 1.7.2
Developed by Fraser Love on 16/03/19
...
--------------------------------------
Patches
- Fixed overall slow response of program by implementing a delay in unconditional statement on time thread
--------------------------------------
--------------------------------------
Improvements
- Condensed code for changing UI elements colour using array of dictionaries
- Further condensed code for changing UI by mergin try statements
- Removed printing to console in favour of switching completely to UI error management system
- Improved modularity of code for further development
--------------------------------------
    ...
    def root_screen(root):
        ...
        def main(root):
            ...
            def sign_in(page, username, password, username_text, password_text, username_input, password_input, login_button):
                ...
                if request_timeout(time.time()) == True:
                    try:
                        ...
                        append_error("Error: cannot contact server")
                    ...
                    try:
                        ...
                        append_error("Error: login failed")
            ...
            def about(root):
                ...
                info1 = Label(bar, text="Version 1.7.2", bg="#333333", fg="white")
