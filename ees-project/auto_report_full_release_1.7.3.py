"""
EES Project Automatic Reporting Software - Release Version 1.7.3
Developed by Fraser Love on 03/04/19
...
--------------------------------------
Improvements
- Changed webserver accessing from Static IP to a Dynamic DNS
--------------------------------------
            ...
            with sr.Microphone() as source:
                try:
                    try:
                        ...
                        append_error("Error: microphone not working")
                    try:
                        text = r.recognize_google(audio)
                    except:
                        append_error("Error: Google speech to text not working")
                    lang = "en"
        ...
        def main(root):
            ...
            def sign_in(page, username, password, username_text, password_text, username_input, password_input, login_button):
                ...
                if request_timeout(time.time()) == True:
                    try:
                        file = urllib.request.urlopen("http://XXXXXXX.ddns.net:3402/static/credentials.txt")
                    except:
            ...
            def about(root):
                ...
                info1 = Label(bar, text="Version 1.7.3", bg="#333333", fg="white")
