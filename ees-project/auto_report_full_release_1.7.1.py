"""
EES Project Automatic Reporting Software - Release Version 1.7.1
Developed by Fraser Love on 15/03/19
...
def app():
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.7.1", bg="#333333", fg="white")
