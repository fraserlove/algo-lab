"""
EES Project Automatic Error Report Software - Development Version 1.4
Developed by Fraser Love on 10/02/19
...
def app():
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.4", bg="#333333", fg="white")
