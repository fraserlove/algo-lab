"""
EES Project Automatic Reporting Software - Release Version 1.6.6
Developed by Fraser Love on 09/03/19
    ...
    def root_screen(root):
        ...
        def main(root):
                            ...
                            if row_no + 7 > gen_id()-1 or row_no == 0:
                                for column in range(len(table_row)):
                                    if column == 11:
                                        ...
                                        element = Label(page, text=table_row[column], bg=check_bg(), fg=check_fg(), font=font, width=50, anchor="w")
            ...
            def login_panel(page, login_time):
                ...
                global stats_header, latest_login, forms_sent, settings_header, r_email_text, s_email_text, r_email_entry, s_email_entry, pass_text, email_password, set_email, live_stream_header, ip_text, ip_entry, port_entry, live_stream_button
            ...
            def theme_update(is_theme):
                ...
                if is_theme == "1":
                    ...
                    if locked == False:
                        ...
                        settings_header.config(bg=light["bg"], fg=light["fg"])
                ...
                if is_theme == "0":
                    ...
                    if locked == False:
                        ...
                        settings_header.config(bg=dark["bg"], fg=dark["fg"])
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.6", bg="#333333", fg="white")
