"""
EES Project Automatic Error Report Software - Development Version 1.6.1
Developed by Fraser Love on 03/03/19
...
def app():
    ...
    def take_picture():
        ...
        try:
            ...
            i = 1
            while exists:
                if os.path.isfile(("image-{}.jpg").format(i)) == False:
    ...
    def root_screen(root):
        ...
        def main(root):
            ...
            def machine_info(page):
                ...
                picture_button = Button(page, text="Take Picture", fg="white", bg="#474747", borderwidth=0, height = 1, width = 12, activebackground="#333333", activeforeground="white",  font=('Segoe UI', '12'), command=lambda:open_img(page, take_picture()))
                picture_button.place(x=10, y=520)
                ...
                remove_button.place(x=10, y=560)
            ...
            def open_img(page, img_path):
                global file_text, attach_file, file_array
                file_array.append(img_path)
                file_name_array.append(img_path)
                            ...
                            if row_no + 6 > gen_id()-1 or row_no == 0:
                                for column in range(len(table_row)):
                                    if column == 11:
                                        ...
                                        element = Label(page, text=table_row[column], bg="#161616", fg="white", font=font, width=20, anchor="w")
                                        element.place(x=column*110, y=630+active_row*30, anchor="w")
                                    else:
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.1", bg="#333333", fg="white")
