"""
EES Project Automatic Reporting Software - Release Version 1.6.8
Developed by Fraser Love on 11/03/19
...
def app():
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.8", bg="#333333", fg="white")
