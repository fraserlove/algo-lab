"""
EES Project Automatic Reporting Software - Release Version 1.6.9
Developed by Fraser Love on 12/03/19
...
- Ability to email and text head office
...
def app():
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.9", bg="#333333", fg="white")
