"""
EES Project Automatic Error Report Software - Development Version 1.6.5
Developed by Fraser Love on 08/03/19
...
def app():
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.5", bg="#333333", fg="white")
