"""
EES Project Automatic Reporting Software - Release Version 1.6.7
Developed by Fraser Love on 10/03/19
...
def app():
    ...
    def error_system(page):
        global error_header, error_canvas
    ...
    def root_screen(root):
        ...
        def about(root):
            ...
            info1 = Label(bar, text="Version 1.6.7", bg="#333333", fg="white")
