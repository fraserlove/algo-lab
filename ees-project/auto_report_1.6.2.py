...
def app():
        ...
        try:
            ...
            while exists:
                if os.path.isfile(("media/video-{}.mp4").format(i)) == False:
                    ...
                    out = cv2.VideoWriter(("media/video-{}.mp4".format(i)), fourcc, 60.0, (root.winfo_screenwidth(), root.winfo_screenheight()))
                    exists = False
    ...
    def video_cap():
        ...
        try:
            ...
            while exists:
                if os.path.isfile(("media/video-{}.mp4").format(i)) == False:
                    out = cv2.VideoWriter(("media/video-{}.mp4".format(i)), fourcc, 60.0, (int(width), int(height)))
                    exists = False
                    vid_path = ("media/video-{}.mp4".format(i))
                else:
                    i += 1
